...
import { Work_Sans, Playfair_Display, Cormorant_Garamond, Cinzel, Marcellus, Tenor_Sans } from "next/font/google";
...
export default function RootLayout({
  ...
  return (
    <html suppressHydrationWarning lang="en" className={clsx(
      workSans.variable,
      playfair.variable,
      cormorant.variable,
      cinzel.variable,

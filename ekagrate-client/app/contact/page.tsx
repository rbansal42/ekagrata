    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-6xl mx-auto px-6 -mt-32 relative z-10 pb-24">
        <div className="grid md:grid-cols-3 gap-6">
          ...
          <Link
            className="group"
            href={`https://wa.me/${data.attributes.whatsapp_number.replace(/\D/g, "")}`}
            target="_blank"
          >
          ...
          <Link
            className="group"
            href={`https://instagram.com/${data.attributes.instagram_handle}`}
            target="_blank"
          >
            <div className="bg-white/80 backdrop-blur-lg p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 text-center h-full">
              ...
              <p className="text-gray-600 font-light group-hover:text-pink-600 transition-colors duration-300">
                @{data.attributes.instagram_handle}
              </p>
            </div>
          </Link>

          {/* Email Card */}
          <Link className="group" href={`mailto:${data.attributes.contact_email}`}>
            <div className="bg-white/80 backdrop-blur-lg p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 text-center h-full">
        ...
        <div className="mt-24 text-center max-w-2xl mx-auto">
          ...
          <p className="text-lg text-gray-600 font-light leading-relaxed">
            ...
            collaborating? We&apos;d love to hear from you. Reach out through any of
            these channels and we&apos;ll get back to you soon.
          </p>
        </div>
      </div>
    </div>
